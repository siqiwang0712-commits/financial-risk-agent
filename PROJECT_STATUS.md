...
## v0.3.3 — Reproducibility & Runtime Integrity
...
credential, and a Postgres healthcheck that probes the container address instead of
loopback.
...
v0.3.1 is the immutable historical empirical baseline. The v0.3.2 release gate covers
