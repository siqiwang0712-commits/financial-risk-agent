...
def altman_z(v: dict, entity_type="public_manufacturer") -> ModelResult:
    ...
    if invalid:return ModelResult("Altman Z-Score",None,"Invalid input domain","Applicable to public manufacturers only",v,"1.2X1+1.4X2+3.3X3+0.6X4+1.0X5",invalid)
